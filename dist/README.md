...
This is forked from [react-split-pane](https://github.com/tomkp/react-split-pane) for typescript support and some additional API (v2)

## Differences from [react-split-pane](https://github.com/tomkp/react-split-pane) (v2)

1. TS - Pane and Resizer
